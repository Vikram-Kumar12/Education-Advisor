...
const ArtsStream = () => {
  ...
  const arts = {
    ...
    reviews: 87,
    description:
      "Bachelor of Arts in Psychology explores human behavior, mental processes, and psychological principles through theoretical and practical approaches.",
    careers: [
              ...
              <div className="p-6">
                ...
                {activeTab === "overview" && (
                  <div>
                    ...
                    <p className="text-gray-400 mb-6">{arts.description}</p>
                  ...
                  <div>
                    ...
                    <div className="mb-6">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {arts.topRecruiters.map((recruiter, index) => (
                          <span
                            key={index}
                    ...
                    <div>
                      ...
                      <div className="bg-orange-900/20 p-4 rounded-lg border border-orange-500/30">
                        <p className="text-orange-300 font-medium">
                          Job growth projection: {arts.growth}
                        </p>
                        <p className="text-sm text-orange-400 mt-1">
                ...
                {activeTab === "exams" && (
                  <div>
                    ...
                    <div className="space-y-4">
                      {arts.entranceExams.map((exam, index) => (
                        <motion.div
                          key={index}
          ...
          >
            ...
            <div className="space-y-4 mb-6">
              <div className="flex items-center text-gray-300">
                ...
                <span>{arts.colleges}+ colleges available</span>
              </div>
              <div className="flex items-center text-gray-300">
