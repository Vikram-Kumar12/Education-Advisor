...
const CommerceStream = () => {
  ...
  const commerce = {
    ...
    reviews: 98,
    description:
      "Bachelor of Commerce in Accounting provides comprehensive knowledge of accounting principles, financial management, taxation, and business laws.",
    careers: [
      ...
      <div className="max-w-6xl mx-auto w-full relative z-10">
        ...
        <div className="grid grid-cols-1  gap-6">
          ...
          <div className="lg:col-span-2">
            ...
            >
              <div className="flex flex-nowrap justify-between items-center gap-1 md:gap-2">
                {/* Overview */}
                <button
              ...
              <div className="p-6">
                ...
                {activeTab === "overview" && (
                  <div>
                    ...
                    <p className="text-gray-400 mb-6">{commerce.description}</p>
                ...
                {activeTab === "careers" && (
                  <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                      {commerce.careers.map((career, index) => (
                        <motion.div
                          key={index}
                    ...
                    <div className="mb-6">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {commerce.topRecruiters.map((recruiter, index) => (
                          <span
                            key={index}
                    ...
                    <div>
                      ...
                      <div className="bg-orange-900/20 p-4 rounded-lg border border-orange-500/30">
                        <p className="text-orange-300 font-medium">
                          Job growth projection: {commerce.growth}
                        </p>
                        <p className="text-sm text-orange-400 mt-1">
                ...
                {activeTab === "exams" && (
                  <div>
                    ...
                    <div className="space-y-4">
                      {commerce.entranceExams.map((exam, index) => (
                        <motion.div
                          key={index}
                ...
                {activeTab === "skills" && (
                  <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                      {commerce.skills.map((skill, index) => (
                        <motion.div
                          key={index}
                          whileHover={{ scale: 1.02 }}
          ...
          >
            ...
            <div className="space-y-4 mb-6">
              <div className="flex items-center text-gray-300">
                ...
                <span>{commerce.colleges}+ colleges available</span>
              </div>
              <div className="flex items-center text-gray-300">
