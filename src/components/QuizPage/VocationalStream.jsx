...
const VocationalStream = () => {
  ...
  const vocational = {
    ...
    reviews: 112,
    description:
      "Diploma in Digital Marketing provides practical skills in online marketing strategies, social media management, SEO, and digital advertising.",
    careers: [
      ...
      <div className="max-w-6xl mx-auto w-full relative z-10">
        ...
        <div className="grid grid-cols-1  gap-6">
          ...
          <div className="lg:col-span-2">
            ...
            >
              <div className="flex flex-nowrap justify-between gap-1 md:gap-2">
                {/* Overview */}
                <button
              ...
              <div className="p-6">
                      ...
                      <div className="flex items-center mr-4">
                        {[...Array(5)].map((_, i) => (
                          <Star
                            key={i}
                            className={`h-5 w-5 ${
                              i < Math.floor(vocational.rating)
                ...
                {activeTab === "careers" && (
                  <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                      {vocational.careers.map((career, index) => (
                        <motion.div
                          key={index}
                    ...
                    <div className="mb-6">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {vocational.topRecruiters.map((recruiter, index) => (
                          <span
                            key={index}
                    ...
                    <div>
                      ...
                      <div className="bg-orange-900/20 p-4 rounded-lg border border-orange-500/30">
                        <p className="text-orange-300 font-medium">
                          Job growth projection: {vocational.growth}
                        </p>
                        <p className="text-sm text-orange-400 mt-1">
                ...
                {activeTab === "exams" && (
                  <div>
                    ...
                    <div className="space-y-4">
                      {vocational.entranceExams.map((exam, index) => (
                        <motion.div
                          key={index}
                ...
                {activeTab === "skills" && (
                  <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                      {vocational.skills.map((skill, index) => (
                        <motion.div
                          key={index}
                          whileHover={{ scale: 1.02 }}
          ...
          >
            ...
            <div className="space-y-4 mb-6">
              <div className="flex items-center text-gray-300">
                ...
                <span>{vocational.colleges}+ colleges available</span>
              </div>
              <div className="flex items-center text-gray-300">
