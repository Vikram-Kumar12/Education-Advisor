// components/LearningResources.jsx
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-extrabold text-gray-900 sm:text-5xl sm:tracking-tight lg:text-6xl bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-indigo-600">
            Learning Resources & Scholarships
          </h2>
          <p className="mt-4 max-w-2xl mx-auto text-xl text-gray-600">
            Discover free educational resources, online courses, and scholarship opportunities to advance your learning journey.
          </p>
        </div>

        <div className="flex flex-col items-center">
          <div className="tabs-container bg-white rounded-xl shadow-lg p-1 mb-10 inline-flex">
          ...
          {loading ? (
            ...
            <div className="resources-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 w-full">
              {data[activeTab].map((item, idx) => (
                <div 
                  key={idx} 
                  className="resource-card bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2"
                >
                  <div className="p-6">
                    <div className="flex items-center mb-4">
                      ...
                      <h4 className="ml-4 text-lg font-bold text-gray-900">{item.title}</h4>
                    </div>
                    ...
                    >
                      {downloading === item.title ? (
                        ...
                        <>
                          ...
                          {activeTab === "Scholarships" ? "Apply Now" : "Download Now"}
                        </>
                      )}
                    </button>
                  </div>
        ...
        <div className="mt-16 text-center">
          <div className="bg-white rounded-2xl shadow-lg p-8">
            ...
            <p className="text-gray-600 mb-6">Join our newsletter to get notified about new learning resources and scholarship opportunities.</p>
            <div className="max-w-md mx-auto flex">
              ...
              />
              <button className="bg-gradient-to-r from-blue-500 to-indigo-500 text-white px-6 py-3 rounded-r-lg font-medium hover:from-blue-600 hover:to-indigo-600 transition-all duration-300">
                Subscribe
              </button>
            </div>
          </div>
